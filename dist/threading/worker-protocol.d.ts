...
export type MainToWorkerMessage = MainToWorker_Init | MainToWorker_Probe | MainToWorker_Exec | MainToWorker_Stdin | MainToWorker_Signal | MainToWorker_Resize | MainToWorker_VFSSync | MainToWorker_VFSSnapshot | MainToWorker_VFSInvalidate | MainToWorker_VFSChunk | MainToWorker_SpawnResult | MainToWorker_ChildOutput | MainToWorker_ChildExit | MainToWorker_HttpRequest | MainToWorker_HttpClientResponse | MainToWorker_IPC | MainToWorker_WsUpgrade | MainToWorker_WsData | MainToWorker_WsClose;
...
export type WorkerToMainMessage = WorkerToMain_Ready | WorkerToMain_ProbeReady | WorkerToMain_Stdout | WorkerToMain_Stderr | WorkerToMain_Exit | WorkerToMain_Console | WorkerToMain_VFSWrite | WorkerToMain_VFSDelete | WorkerToMain_VFSSnapshot | WorkerToMain_SpawnRequest | WorkerToMain_ChildSignal | WorkerToMain_ChildStdin | WorkerToMain_ForkRequest | WorkerToMain_WorkerThreadRequest | WorkerToMain_WasiWorkerRequest | WorkerToMain_WasiWorkerTerminate | WorkerToMain_SpawnSync | WorkerToMain_ServerListen | WorkerToMain_ServerClose | WorkerToMain_HttpRequest | WorkerToMain_HttpClientRequest | WorkerToMain_CwdChange | WorkerToMain_StdinRawStatus | WorkerToMain_HttpResponse | WorkerToMain_IPC | WorkerToMain_ShellDone | WorkerToMain_Error | WorkerToMain_SqlitePreload | WorkerToMain_WsFrame;
