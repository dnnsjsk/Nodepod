...
export declare const nodepodMatchers: readonly ["/__sw__.js", "/__nodepod_bridge__.html", "/__nodepod_bridge__.js"];
/**
...
export declare function GET_PREVIEW_BRIDGE(req?: NextRequest): Promise<NextResponseType>;
/** Route handler for `app/__nodepod_bridge__.js/route.ts`. */
export declare function GET_PREVIEW_BRIDGE_SCRIPT(): Promise<NextResponseType>;
/**
