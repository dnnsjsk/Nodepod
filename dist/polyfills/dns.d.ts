...
export declare function resolve(host: string, cb: (err: Error | null, addrs?: string[]) => void): void;
export declare function resolve4(host: string, cb: (err: Error | null, addrs?: string[]) => void): void;
export declare function resolve6(host: string, cb: (err: Error | null, addrs?: string[]) => void): void;
