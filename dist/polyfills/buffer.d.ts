declare class BufferPolyfill extends Uint8Array {
    ...
    static alloc(len: number, fillValue?: number | string | Uint8Array, encoding?: string): BufferPolyfill;
    static allocUnsafe(len: number): BufferPolyfill;
    static allocUnsafeSlow(len: number): BufferPolyfill;
    static concat(list: (Uint8Array | BufferPolyfill)[], totalLength?: number): BufferPolyfill;
