...
export declare function scrypt(password: BinaryInput, salt: BinaryInput, keyLen: number, opts: ScryptOptions | undefined | ((err: Error | null, key: Buffer) => void), cb?: (err: Error | null, key: Buffer) => void): void;
export declare function scryptSync(password: BinaryInput, salt: BinaryInput, keyLen: number, opts?: ScryptOptions): Buffer;
...
export declare function generateKeyPairSync(_type: string, _options?: {
...
export declare function generatePrimeSync(size: number, options?: {
    bigint?: boolean;
    safe?: boolean;
}): Buffer | bigint;
...
export declare function checkPrimeSync(candidate: Buffer | bigint, options?: {
    checks?: number;
}): boolean;
export declare function checkPrime(candidate: Buffer | bigint, optionsOrCb?: {
    checks?: number;
} | ((err: Error | null, result: boolean) => void), cb?: (err: Error | null, result: boolean) => void): void;
...
export declare function getDiffieHellman(groupName: string): any;
export declare function createDiffieHellman(sizeOrPrime: number | Buffer, generator?: number | Buffer): any;
