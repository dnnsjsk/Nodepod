import type { MemoryVolume, FileStat, FileWatchHandle, WatchCallback, WatchEventKind, VolumeFileHandle } from "../memory-volume";
...
interface DirentConstructor {
    new (entryName: string, isDir: boolean, isFile: boolean, parentPath?: string, isSymlink?: boolean): Dirent;
    (this: any, entryName: string, isDir: boolean, isFile: boolean, parentPath?: string, isSymlink?: boolean): void;
    prototype: any;
}
...
export declare class StatWatcher {
    ...
    private _interval;
    private _poll;
    start(_filename: string, _persistent?: boolean, interval?: number, poll?: () => void): void;
    stop(): void;
    ref(): this;
    unref(): this;
...
interface FsPromisesShape {
    ...
    readFile(target: PathArg, encOrOpts?: string | {
        encoding?: string | null;
    }): Promise<Buffer | string>;
    writeFile(target: PathArg, data: string | Uint8Array, opts?: WriteFileOptions): Promise<void>;
    ...
    glob(pattern: string | string[], opts?: GlobOptions): AsyncIterable<string | Dirent>;
...
export interface FsBridge {
    ...
    readFileSync(target: PathArg, encOrOpts?: string | {
        encoding?: string | null;
    }): Buffer | string;
    writeFileSync(target: PathArg, data: string | Uint8Array, opts?: WriteFileOptions | string): void;
    ...
    watchFile(filename: unknown, optsOrListener?: unknown, listener?: unknown): StatWatcher;
    ...
    readdir(target: string, opts: {
        withFileTypes?: boolean;
        encoding?: string;
    } | string, cb: (err: Error | null, entries?: string[] | Buffer[] | Dirent[]) => void): void;
