...
export interface IncomingMessageConstructor {
    ...
    prototype: any;
    build(verb: string, target: string, hdrs: Record<string, string>): IncomingMessage;
}
...
export declare function setHttpClientBridge(fn: HttpClientBridge | null): void;
...
declare const _default: {
    ...
    setHttpClientBridge: typeof setHttpClientBridge;
