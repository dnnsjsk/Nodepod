...
export declare const promises: {
    gzip: (input: Buffer | string) => Promise<Buffer>;
    gunzip: (input: Buffer | string) => Promise<Buffer>;
    deflate: (input: Buffer | string) => Promise<Buffer>;
    inflate: (input: Buffer | string) => Promise<Buffer>;
    deflateRaw: (input: Buffer | string) => Promise<Buffer>;
    inflateRaw: (input: Buffer | string) => Promise<Buffer>;
    brotliCompress: (input: Buffer | string) => Promise<Buffer>;
    brotliDecompress: (input: Buffer | string) => Promise<Buffer>;
};
