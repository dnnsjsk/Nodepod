...
import type { NodepodOptions, NodepodProfiler, NodepodRequestOptions, TerminalOptions, Snapshot, SnapshotOptions, SpawnOptions } from "./types";
...
export declare class Nodepod {
    ...
    private _headless;
    private _rewriteTerminalUrls;
    private _terminalUrlOutputStreams;
     ...
     */
    request(port: number, init?: NodepodRequestOptions): Promise<CompletedResponse>;
    spawn(cmd: string, args?: string[], opts?: SpawnOptions): Promise<NodepodProcess>;
    private _createTerminalUrlOutput;
    private _finishTerminalUrlOutput;
